...
export function ShippingEstimateCreate({
  sourceCountryCode,
  ...
  const [weight, setWeight] = useState(""); // Weight in grams (for display)
      ...
      {isExpanded && (
        <CardContent className="space-y-4">
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label htmlFor="estimate-weight">Weight (g)</Label>
                <Input
                  id="estimate-weight"
                  type="number"
                  step="1"
                  ...
                  value={weight}
                  onChange={(e) =>
                    setWeight(normalizeWeightInput(e.target.value))
                  }
                />
              </div>
                  ...
                  <Card className="border-2 border-purple-200 rounded-lg bg-white">
                    <CardContent className="p-6">
                      <div className="flex flex-col md:flex-row items-center justify-around gap-6 mb-4">
                        ...
                        <div className="space-y-1">
                          <p className="text-sm text-muted-foreground">
                            Destination Currency ({destinationCountryCurrency})
                          </p>
                          <p className="text-2xl font-bold text-purple-600">
          ...
          {shouldUseReceivingCountryPrice &&
            ...
            areRequiredFieldsFilled() && (
              <div className="text-sm text-muted-foreground text-center py-4">
                Shipping price not available for this route. Please check your
                inputs.
              </div>
            )}
        </CardContent>
