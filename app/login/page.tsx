...
/**
 * Centralized API error messages for consistent error handling
 */
...
/**
 * Form validation messages separate from API errors for better maintainability
 */
...
/**
 * TypeScript interfaces for form data and error handling
 */
  ...
  return (
    <PublicRoute>
      <div className="flex min-h-screen w-full flex-col overflow-hidden lg:flex-row">
        ...
        {toast && <CustomToast {...toast} onClose={hideToast} />}
      </div>
    </PublicRoute>
  );